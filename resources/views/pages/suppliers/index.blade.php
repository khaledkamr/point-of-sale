...
@section('content')
                ...
                <form class="flex-1">
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown" name="search" value="{{ request('search') }}"
                            ...
                            placeholder="إبحث عن مورد بالإسم" />
                        @if (request('search'))
                            <a href="{{ route('warehouses.index', array_merge(request()->except('search'), request()->only(['type']))) }}"
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <label class="inline-flex items-center cursor-pointer">
                                            ...
                                            <input type="checkbox" name="is_active" id="activeEdit" value="1"
                ...
                <table class="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-sm">
                    ...
                    <tbody>
                        @forelse ($suppliers as $supplier)
                            <tr
                                class="hover:bg-orange-100 transition-colors duration-200 {{ !$supplier->active ? 'opacity-50 bg-gray-50' : '' }}">
                                ...
                                <td class="p-4 text-center border-b border-gray-200">
                                    @if ($supplier->img_url)
                                        <img src="{{ asset('storage/' . $supplier->img_url) }}" alt="شعار المورد"
                                            class="w-12 h-12 object-contain mx-auto {{ !$supplier->active ? 'grayscale' : '' }}">
                                    @else
                                        <div
                                            class="w-12 h-12 bg-gray-100 flex items-center justify-center rounded-lg mx-auto">
                                ...
                                <td class="p-4 text-center border-b border-gray-200">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        <button data-modal-target="edit-supplier-modal{{ $supplier->id }}"
                                            data-modal-toggle="edit-supplier-modal{{ $supplier->id }}" type="button"
                                        ...
                                        <button data-modal-target="delete-modal{{ $supplier->id }}"
                                            data-modal-toggle="delete-modal{{ $supplier->id }}" type="button"
                            ...
                            {{-- edit modal --}}
                            <div id="edit-supplier-modal{{ $supplier->id }}" tabindex="-1" aria-hidden="true"
                                class="modal hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-6xl max-h-full">
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        <div
                                            ...
                                            <form action="{{ route('suppliers.update', $supplier) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                                    <div>
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">الاسم بالعربية</label>
                                                            <input type="text" name="name_ar" required value="{{ $supplier->name_ar }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('name_ar')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">رقم السجل التجاري</label>
                                                            <input type="text" name="CR" value="{{ $supplier->CR }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('CR')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">رقم IBAN</label>
                                                            <input type="text" name="IBAN" value="{{ $supplier->IBAN }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('IBAN')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                    ...
                                                    <div>
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">الاسم بالإنجليزية</label>
                                                            <input type="text" name="name_en" required value="{{ $supplier->name_en }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('name_en')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">حد الائتمان</label>
                                                            <input type="number" step="0.01" name="credit_limit" value="{{ $supplier->credit_limit }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('credit_limit')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                    ...
                                                    <div>
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">النوع</label>
                                                            <select name="type" class="w-full p-0 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                                <option value="محلي" {{ $supplier->type == 'محلي' ? 'selected' : '' }}>محلي</option>
                                                                <option value="دولي" {{ $supplier->type == 'دولي' ? 'selected' : '' }}>دولي</option>
                                                            </select>
                                                            @error('type')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">نسبة الضريبة (%)</label>
                                                            <input type="number" step="0.01" name="tax_rate" value="{{ $supplier->tax_rate }}"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                            @error('tax_rate')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="activeEdit{{ $supplier->id }}" class="block mb-2 text-sm font-bold text-gray-900">نشط</label>
                                                            <label class="inline-flex items-center cursor-pointer">
                                                                <input type="hidden" name="active" value="0">
                                                                <input type="checkbox" name="active" id="activeEdit{{ $supplier->id }}" value="1"
                                                    ...
                                                    <div>
                                                        <div class="mb-4">
                                                            <label class="block text-sm font-bold text-dark mb-2">صورة الشعار</label>
                                                            <div id="imageBoxEdit{{ $supplier->id }}"
                                                                class="relative cursor-pointer group flex items-center justify-center
                                                                    w-full h-47 border-2 border-dashed border-gray-300 rounded-lg
                                                                    bg-gray-50 hover:bg-orange-100 transition-all duration-200">
                                                                ...
                                                                @if ($supplier->img_url)
                                                                    <!-- Current Image -->
                                                                    <img id="imagePreviewEdit{{ $supplier->id }}"
                                                                        src="{{ asset('storage/' . $supplier->img_url) }}"
                                                                        class="absolute inset-0 w-full h-full object-contain rounded-lg">
    
                                                                    <!-- Overlay -->
                                                                    <div id="imgOverlayEdit{{ $supplier->id }}"
                                                                ...
                                                                @else
                                                                    <!-- Placeholder -->
                                                                    <div id="imgPlaceholderEdit{{ $supplier->id }}"
                                                                        class="flex flex-col items-center text-gray-500 hover:text-orange-700">
                                                                        <i class="fa-solid fa-image text-4xl mb-2"></i>
                                                                        <span class="text-sm">اضغط لاختيار صورة</span>
                                                                    </div>
                                                            ...
                                                            <input id="imageInputEdit{{ $supplier->id }}" type="file" name="img_url" accept="image/*" class="hidden">
                                                            @error('img_url')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                                                        <div>
                                                            ...
                                                            <textarea name="notes" rows="3"
                                                                class="w-full p-1 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">{{ $supplier->notes }}</textarea>
                                                            @error('notes')
                                                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                            @enderror
                                                        </div>
                            ...
                            {{-- delete modal --}}
                            <div id="delete-modal{{ $supplier->id }}" tabindex="-1"
                                class="modal hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow-sm">
                                        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                                            data-modal-hide="delete-modal{{ $supplier->id }}">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"> 
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                            </svg>
                                            <span class="sr-only">إغلاق النافذة</span>
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <p class="mb-5 text-sm font-medium text-amber-600 bg-amber-50 border border-amber-200 rounded-lg p-3">
                                                ...
                                                سيتم حذف جميع البيانات المرتبطة بهذا المورد.
                                            </p>
                                            <form action="{{ route('suppliers.destroy', $supplier) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button data-modal-hide="delete-modal{{ $supplier->id }}" type="submit"
                                                ...
                                                <button data-modal-hide="delete-modal{{ $supplier->id }}" type="button"
                            ...
                            <tr>
                                <td colspan="7" class="p-8 text-center text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-lg">لا يوجد موردين متاحين</p>
    ...
    <script>
        ...
        // Add supplier modal image handling
        ...
        // Edit supplier modals image handling
        @foreach ($suppliers as $supplier)
            (function() {
                const imageBoxEdit = document.getElementById('imageBoxEdit{{ $supplier->id }}');
                const inputEdit = document.getElementById('imageInputEdit{{ $supplier->id }}');
                const previewEdit = document.getElementById('imagePreviewEdit{{ $supplier->id }}');
                const placeholderEdit = document.getElementById('imgPlaceholderEdit{{ $supplier->id }}');
                const overlayEdit = document.getElementById('imgOverlayEdit{{ $supplier->id }}');
