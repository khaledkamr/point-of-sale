                ...
                <div class="flex">
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdown-button">
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-orange-200">فردي</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-orange-200">شركة</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-orange-200">تاجر</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-orange-200">جملة</button>
                            </li>
                        </ul>
                    </div>
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown"
                            ...
                            placeholder="إبحث عن عميل بالاسم أو رقم الهاتف" required />
                        <button type="submit"
            ...
            <div id="add-customer-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow-sm">
                        ...
                        <form action="{{ route('customers.store') }}" method="POST" class="p-4 md:p-5">
                            @csrf
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-bold text-dark mb-2">اسم العميل</label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-dark mb-2">نوع العميل</label>
            ...
            <table class="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-sm">
                <thead>
                    <tr class="bg-gray-200">
                        ...
                        <th class="p-4 text-center font-bold text-gray-700 border-b border-gray-200">الرصيد</th>
                ...
                <tbody>
                    @forelse ($customers as $customer)
                        <tr class="hover:bg-orange-100 transition-colors duration-200">
                            ...
                            <td class="p-4 text-center border-b border-gray-200 text-gray-600">
                                {{ number_format($customer->balance ?? 0, 2) }} ريال
                            </td>
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="p-4">
                                        <form action="{{ route('customers.update', $customer) }}" method="POST"
                                            ...
                                            <div class="space-y-4">
                                                <div>
                                                    <label class="block text-sm font-bold text-dark mb-2">اسم
                                                        العميل</label>
                                                    <input type="text" name="name" required
                                                        value="{{ $customer->name }}"
                                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                ...
                                                <div>
                                                    <label class="block text-sm font-bold text-dark mb-2">نوع
                                                        العميل</label>
                                                    <select name="type" required
                                                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200">
                                                        <option value="">اختر نوع العميل</option>
                                                        <option value="regular"
                                                            {{ $customer->type == 'regular' ? 'selected' : '' }}>عادي</option>
                                                        <option value="cash"
                                                            {{ $customer->type == 'cash' ? 'selected' : '' }}>نقدي</option>
                                                    </select>
                                                    @error('type')
                                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-dark">هل أنت متأكد من حذف العميل
                                            <strong>{{ $customer->name }}</strong>؟</h3>
                        ...
                        <tr>
                            <td colspan="6" class="p-8 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg">لا توجد عملاء متاحين</p>
