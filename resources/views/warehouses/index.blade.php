            ...
            <form class="flex-1">
                <div class="flex">
                    ...
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-orange-500 focus:border-orange-500" placeholder="إبحث عن مستودع بالإسم او بالرقم" required />
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm">
                                    ...
                                    <div class="p-4">
                                        <form action="{{ route('warehouses.update', $warehouse) }}" method="POST" class="pt-3">
                                            ...
                                            <div class="space-y-4">
                                                <div>
                                                    <label class="block text-sm font-bold text-dark mb-2">اسم المستودع</label>
