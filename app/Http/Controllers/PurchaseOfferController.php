...
class PurchaseOfferController extends Controller
{
    public function index()
    {
        ...
        return view('pages.purchase-offers.index', compact('purchaseOffers'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.purchase-offers.create', compact('purchaseRequests', 'suppliers'));
    }
    ...
    public function show(PurchaseOffer $purchaseOffer)
    {
        ...
        return view('pages.purchase-offers.show', compact('purchaseOffer'));
    }
    ...
    public function edit(PurchaseOffer $purchaseOffer)
    {
        $purchaseRequests = PurchaseRequest::all();
        $suppliers = Supplier::all();
        return view('pages.purchase-offers.edit', compact('purchaseOffer', 'purchaseRequests', 'suppliers'));
    }
